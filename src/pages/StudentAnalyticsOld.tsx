...
import { Box, Card, Chip, FormControl, InputLabel, MenuItem, Select, SelectChangeEvent, Stack } from '@mui/material';
...
export default function StudentAnalytics() {
    ...
    return (
        <Box sx={{
            ...
            {studentPromptsData && studentCards ?
                <>
                    <Box gap={3}
                        sx={{
                            mt: 3,
                    ...
                    <Box gap={2}
                        ...
                        <Card
                            ...
                            <LineChart
                                ...
                                xAxis={[
                                    { data: studentProgressScores.map((score) => score.date), scaleType: 'band' }
                                ]}
                                series={[
                                    { data: studentProgressScores.map((score) => score.score), label: 'Score', curve: 'linear', }
                                ]}
                                height={300}
                            />
                        </Card>
